    ...
    <div className="min-h-screen bg-pink-300">
      <div className="container mx-auto py-10 text-center">
        ...
        <p className="text-xl mt-4 text-gray-800">
          Saldo:{" "}
          {balance !== null ? (
            <span className="text-green-500 font-semibold">{balance} kr</span>
          ) : (
            "Laddar..."
          )}
        </p>
        <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
          ...
          <form onSubmit={handleDeposit} className="mt-4">
            <input
              ...
              required
            />
            <button className="mt-6 w-full text-white py-2 rounded-md hover:bg-pink-600 transition duration-300 cursor-pointer">
              Sätt in
            </button>
          </form>
        </div>
