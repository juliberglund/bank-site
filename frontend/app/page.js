  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="flex flex-col items-center justify-center text-center py-20">
        ...
        {loggedIn ? (
          <Link href="/account">
            <button className="mt-6 px-6 py-3 bg-pink-400 text-white rounded-lg shadow-md hover:bg-pink-300 cursor-grab">
              Gå till ditt konto
            </button>
          </Link>
        ) : (
          <Link href="/register">
            <button className="mt-6 px-6 py-3 bg-pink-500 text-white rounded-lg shadow-md hover:bg-pink-300 cursor-grab">
              Skapa användare
            </button>
          </Link>
        )}
